function generateData(e, t, o) {
    for (var a = 0, r = []; a < t;) {
        var s = Math.floor(750 * Math.random()) + 1, i = Math.floor(Math.random() * (o.max - o.min + 1)) + o.min,
...
var columnChart, columnChartoptions = {
    ...
    }, {name: "Visitors", data: [7, 30, 13, 23, 20, 12, 8, 13, 27, 7, 30, 13, 23, 20, 12, 8, 13, 27]}],
    chart: {
        type: "bar",
        height: 350,
        stacked: !1,
    ...
    plotOptions: {bar: {horizontal: !1, columnWidth: "40%", radius: 30, enableShades: !1, endingShape: "rounded"}},
    xaxis: {
        type: "datetime",
    ...
    fill: {opacity: 1, colors: [base.primaryColor, extend.primaryColorLighter]},
    grid: {
        show: !0,
...
var barChart, barChartoptions = {
    series: [{name: "Desktop", data: [44, 55, 41, 64, 22, 43, 21, 53, 32, 33]}, {
        name: "Mobile",
        data: [53, 32, 33, 52, 13, 44, 32, 53, 32, 33]
    }, {name: "Tablet", data: [13, 12, 13, 32, 3, 24, 12, 33, 12, 13]}],
    chart: {type: "bar", height: 350, stacked: !0, columnWidth: "70%", zoom: {enabled: !1}, toolbar: {enabled: !1}},
    theme: {mode: colors.chartTheme},
...
var areachart, areaChartOptions = {
    series: [{
        ...
        name: "Mobile Apps",
        data: [11, 45, 20, 32, 34, 52, 41, 11, 32, 45, 11, 75, 20, 32, 34, 52, 41, 81]
    }, {name: "Others", data: [5, 25, 9, 14, 14, 32, 21, 5, 12, 25, 5, 55, 9, 14, 14, 32, 21, 65]}],
    chart: {
        type: "area",
        height: 350,
        background: "transparent",
    ...
    tooltip: {style: {fontSize: "12px", fontFamily: base.defaultFontFamily}}
...
var lineChartWidget, lineChartWidgetoptions = {
    ...
    chart: {height: 140, type: "line", toolbar: {show: !1}, zoom: {enabled: !1}},
    theme: {mode: colors.chartTheme},
    stroke: {show: !0, curve: "straight", lineCap: "butt", colors: chartColors, width: [3, 2], dashArray: [0, 0]},
    dataLabels: {enabled: !1},
    markers: {size: 0},
    xaxis: {
        type: "datetime",
...
var radarChartWidget, radarChartWidgetOptions = {
    series: [{name: "Mac Os", data: [80, 50, 30, 40, 100, 20]}, {
        name: "Windows",
        data: [20, 30, 40, 80, 20, 80]
    }, {name: "iOS", data: [44, 76, 78, 13, 43, 10]}, {name: "Android", data: [14, 36, 38, 3, 23, 2]}],
    ...
    fill: {opacity: 1, colors: chartColors},
    markers: {size: 0},
    yaxis: {labels: {style: {colors: colors.mutedColor, fontFamily: base.defaultFontFamily}}},
    xaxis: {
        categories: ["01", "02", "03", "04", "05", "06"],
        labels: {title: {colors: colors.mutedColor, fontFamily: base.defaultFontFamily}}
    },
    grid: {borderColor: colors.borderColor, padding: {top: -10, bottom: -10}}
...
var pieChartWidget, pieChartWidgetOptions = {
    series: [686, 575, 426],
    chart: {type: "donut", height: 160, zoom: {enabled: !1}, toolbar: {show: !1}},
    theme: {mode: colors.chartTheme},
    plotOptions: {pie: {donut: {size: "0"}, expandOnClick: !1}},
    labels: ["Desktop", "Tablet", "Mobile"],
    dataLabels: {enabled: !0, style: {fontSize: "10px", fontFamily: base.defaultFontFamily, fontWeight: "300"}},
    legend: {show: !1},
    stroke: {show: !1, colors: extend.primaryColorLight, width: 1, dashArray: 0},
    fill: {opacity: 1, colors: chartColors}
...
var donutChartWidget, donutChartWidgetOptions = {
    ...
    chart: {type: "donut", height: 180, zoom: {enabled: !1}, toolbar: {show: !1}},
    theme: {mode: colors.chartTheme},
    plotOptions: {pie: {donut: {size: "40%", background: "transparent"}, expandOnClick: !1}},
...
var barChartWidget, barChartWidgetoptions = {
    series: [{name: "Revenue", data: [44, 55, 41, 64, 22, 43, 36]}, {
        name: "Total",
        data: [53, 32, 33, 52, 13, 44, 26]
    }, {name: "Cost", data: [13, 12, 13, 32, 3, 24, 18]}],
    chart: {type: "bar", height: 165, stacked: !0, zoom: {enabled: !0}, toolbar: {show: !1}},
    theme: {mode: colors.chartTheme},
    dataLabels: {enabled: !1},
    plotOptions: {bar: {horizontal: !0, columnWidth: "20%", barHeight: "40%"}},
    xaxis: {
    ...
    legend: {show: !1},
    fill: {opacity: 1, colors: chartColors},
    grid: {show: !1, padding: {top: -15, right: -15, bottom: -15, left: -10}, position: "back"}
...
var areaChartWidget, areaChartWidgetOptions = {
    series: [{
        name: "Website",
        data: [31, 28, 30, 51, 42, 109, 100, 31, 40, 28, 31, 58, 30, 51, 42, 109, 100, 98]
    }, {
        name: "Mobile Apps",
        data: [11, 45, 20, 32, 34, 52, 41, 11, 32, 45, 11, 75, 20, 32, 34, 52, 41, 50]
    }, {name: "Others", data: [5, 25, 9, 14, 14, 32, 21, 5, 12, 25, 5, 55, 9, 14, 14, 32, 21, 30]}],
    chart: {type: "area", height: 190, stacked: !0, toolbar: {show: !1}, zoom: {enabled: !0}},
    theme: {mode: colors.chartTheme},
    xaxis: {
        type: "datetime",
        categories: ["01/01/2020 GMT", "01/02/2020 GMT", "01/03/2020 GMT", "01/04/2020 GMT", "01/05/2020 GMT", "01/06/2020 GMT", "01/07/2020 GMT", "01/08/2020 GMT", "01/09/2020 GMT", "01/10/2020 GMT", "01/11/2020 GMT", "01/12/2020 GMT", "01/13/2020 GMT", "01/14/2020 GMT", "01/15/2020 GMT", "01/16/2020 GMT", "01/17/2020 GMT", "01/18/2020 GMT"],
...
var columnChartWidget, columnChartWidgetoptions = {
    ...
    }, {name: "Visitors", data: [7, 30, 13, 23, 20, 12, 8, 13, 27, 7, 30, 13, 23]}],
    chart: {type: "bar", height: 150, stacked: !1, columnWidth: "70%", toolbar: {show: !1}, zoom: {enabled: !1}},
    theme: {mode: colors.chartTheme},
    dataLabels: {enabled: !1},
    plotOptions: {bar: {horizontal: !1, columnWidth: "40%", radius: 30, enableShades: !1, endingShape: "rounded"}},
    xaxis: {
...
var columnChartWidget2, columnChartWidget2options = {
    ...
    chart: {type: "bar", height: 240, stacked: !1, columnWidth: "70%", toolbar: {show: !1}, zoom: {enabled: !1}},
    theme: {mode: colors.chartTheme},
    dataLabels: {enabled: !1},
    plotOptions: {bar: {horizontal: !1, columnWidth: "40%", radius: 30, enableShades: !1, endingShape: "rounded"}},
    xaxis: {
...
var heatmapchart, heatmapChartOptions = {
    series: [{name: "Set 1", data: [61, 98, 16, 9, 97, 20, 14, 18, 19, 33, 76, 78, 63, 89, 99, 30]}, {
        name: "Set 2",
        data: [77, 76, 10, 47, 13, 56, 71, 83, 32, 57, 87, 96, 99, 85, 1, 15]
    }, {name: "Set 3", data: [48, 23, 27, 90, 37, 32, 88, 96, 65, 46, 63, 17, 40, 42, 77, 41]}, {
        name: "Set 4",
        data: [70, 33, 71, 90, 34, 63, 93, 80, 39, 40, 41, 67, 86, 8, 91, 79]
    }, {name: "Set 5", data: [78, 98, 19, 74, 41, 59, 95, 99, 37, 17, 11, 60, 44, 7, 61, 39]}, {
        name: "Set 6",
        data: [46, 95, 52, 36, 34, 65, 2, 3, 13, 77, 72, 71, 93, 25, 83, 98]
    }, {name: "Set 7", data: [2, 93, 68, 3, 53, 56, 79, 64, 46, 14, 22, 94, 60, 81, 51, 15]}, {
        name: "Set 8",
...
var bubblechart, bubbleChartOptions = {
    series: [{
        ...
        name: "Type 3",
        data: generateData(new Date("11 Feb 2017 GMT").getTime(), 20, {min: 10, max: 60})
    }, {name: "Type 4", data: generateData(new Date("11 Feb 2017 GMT").getTime(), 20, {min: 10, max: 60})}],
    chart: {height: 350, type: "bubble", zoom: {enabled: !1}, sparkline: {enabled: !1}},
    theme: {mode: colors.chartTheme},
    dataLabels: {enabled: !1},
    colors: chartColors,
    xaxis: {
    ...
    legend: {
        ...
        fontWeight: 400,
        labels: {colors: colors.mutedColor, useSeriesColors: !1},
        markers: {width: 10, height: 10, strokeWidth: 0, strokeColor: colors.borderColor, radius: 6},
        itemMargin: {horizontal: 10, vertical: 0},
        onItemClick: {toggleDataSeries: !0},
        onItemHover: {highlightDataSeries: !0}
    },
...
var radarchart, radarChartOptions = {
    series: [{name: "Mac Os", data: [80, 50, 30, 40, 100, 20]}, {
        name: "Windows",
        data: [20, 30, 40, 80, 20, 80]
    }, {name: "iOS", data: [44, 76, 78, 13, 43, 10]}, {name: "Android", data: [14, 36, 38, 3, 23, 2]}],
...
radarChartCtn && (radarchart = new ApexCharts(radarChartCtn, radarChartOptions)).render();
var candlechart, candleChartOptions = {
    series: [{
        data: [{x: new Date(15387786e5), y: [6629.81, 6650.5, 6623.04, 6633.33]}, {
    ...
    chart: {type: "candlestick", height: 325, zoom: {enabled: !1}, toolbar: {show: !1}},
    theme: {mode: colors.chartTheme},
    xaxis: {
        type: "datetime",
        labels: {
...
var multiRadialbarChart, multiRadialbarOptions = {
    series: [44, 55, 67, 83],
    chart: {height: 200, type: "radialBar"},
    plotOptions: {
        radialBar: {
...
multiRadialbar && (multiRadialbarChart = new ApexCharts(multiRadialbar, multiRadialbarOptions)).render();
var customAngleChart, customAngleOptions = {
    series: [76, 67, 61, 90],
    ...
    plotOptions: {
        radialBar: {
            ...
            endAngle: 270,
            track: {background: colors.borderColor},
            hollow: {margin: 5, size: "40%", background: "transparent", image: void 0},
    ...
    legend: {
        show: !1, floating: !0, labels: {useSeriesColors: !0}, markers: {size: 0}, formatter: function (e, t) {
            return e + ":  " + t.w.globals.series[t.seriesIndex]
        }, itemMargin: {vertical: 3}
    },
    stroke: {lineCap: "round"}
}, customAngle = document.querySelector("#customAngle");
customAngle && (customAngleChart = new ApexCharts(customAngle, customAngleOptions)).render();
var gradientRadialChart, gradientRadialOptions = {
    ...
    plotOptions: {
        radialBar: {
            ...
            track: {background: colors.backgroundColor, strokeWidth: "67%", margin: 0},
            dataLabels: {
                show: !0,
                name: {
                    fontSize: "0.875rem",
...
var strokeRadialChart, strokeRadialOptions = {
    series: [67],
...
strokeRadial && (strokeRadialChart = new ApexCharts(strokeRadial, strokeRadialOptions)).render();
var semiRadialChart, semiRadialOptions = {
    series: [76],
    ...
    plotOptions: {
        radialBar: {
            startAngle: -90,
            endAngle: 90,
            track: {background: colors.borderColor, strokeWidth: "97%", margin: 5},
            dataLabels: {
                name: {show: !1},
                value: {
                    offsetY: -2,
...
semiRadial && (semiRadialChart = new ApexCharts(semiRadial, semiRadialOptions)).render();
